...
import 'package:netflix_clone/screens/movie_detail.dart';
                            ...
                            return searchedMovie!.results[index].backdropPath ==
                                ...
                                ? Column(
                                    children: [
                                      ...
                                      Text(
                                        searchedMovie?.results[index].mediaType == "movie"
                                            ? searchedMovie?.results[index].title ?? "h1"
                                            :  searchedMovie?.results[index].mediaType == "tv"
                                                ? searchedMovie?.results[index].name ?? 'h1'
                                                : 'Unknown',
                                        maxLines: 2,
                                        style: const TextStyle(
                                          fontSize: 14,
                                ...
                                : Column(
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          if(searchedMovie?.results[index].mediaType == "movie"){
                                            Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) =>
                                          ...
                                          } else if(searchedMovie?.results[index].mediaType == "tv"){
                                            Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) =>
